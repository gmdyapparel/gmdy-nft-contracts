...
pub contract GMDYMarketPlace {
    ...
    pub resource interface SalePublic {
        pub fun purchase(tokenID: UInt64, recipient: &AnyResource{GMDYNFTContract.NFTReceiver}, buyTokens: @GMDYFungibleToken.Vault)
    ...
    pub resource SaleCollection: SalePublic {
        ...
        pub let ownerVault: Capability<&AnyResource{GMDYFungibleToken.Receiver}>

        init (vault: Capability<&AnyResource{GMDYFungibleToken.Receiver}>) {
            self.forSale <- {}
    ...
    pub fun createSaleCollection(ownerVault: Capability<&AnyResource{GMDYFungibleToken.Receiver}>): @SaleCollection {
